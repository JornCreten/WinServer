...
Copy-Item "Z:\SCCM\SCCM_Files" -Destination "C:\SCCM_Files" -recurse


# Install SCCM (Current Branch) version 2002
...
$SCCMPath = "C:\SCCM_Files"
$PrerequisitesPath = "$SourcePath" + "\SCCMPrereqs"
$DestinationServer = "WIN-SCCM.jorn.corona"
